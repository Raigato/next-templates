...
```
npx create-next-app --use-npm -e "https://github.com/Raigato/next-templates/tree/master/with-styled-components"
```

**yarn**

```
yarn create next-app -e "https://github.com/Raigato/next-templates/tree/master/with-styled-components"
```
